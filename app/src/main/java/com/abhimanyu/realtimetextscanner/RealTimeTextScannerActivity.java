...
public class RealTimeTextScannerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //textExtracted = (TextView) findViewById(R.id.text_view);
        textExtracted = (EditText) findViewById(R.id.text_extracted);

        confirmProduct = (Button) findViewById(R.id.confirmText);
        confirmProduct.setOnClickListener(new View.OnClickListener() {
             @Override
             public void onClick(View v) {

                 Intent i = new Intent(getApplicationContext(), ExtractedTextActivity.class);
                 i.putExtra("ExtractedText", finalString);
                 startActivity(i);
                 finish();
        ...
        if (!textRecognizer.isOperational()) {
            ...
            textRecognizer.setProcessor(new Detector.Processor<TextBlock>() {
                ...
                public void receiveDetections(Detector.Detections<TextBlock> detections) {
                    ...
                    if (items.size() != 0) {
                        textExtracted.post(new Runnable() {
                            @Override
                            public void run() {
                                ...
                                textExtracted.setText(stringBuilder.toString());
                            }
                        });
                    }
                }
